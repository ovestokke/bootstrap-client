...
echo -e "  2. Run Powerlevel10k configuration wizard: ${YELLOW}p10k configure${NC}"
echo -e "  3. For coolnight theme colors, choose ${YELLOW}lean${NC} (8 colors) or ${YELLOW}rainbow${NC} style"
echo ""
echo -e "${CYAN}Tips:${NC}"
echo -e "  - Use ${YELLOW}ls${NC} (eza) for better file listings with icons"
echo -e "  - Use ${YELLOW}cd${NC} or ${YELLOW}z${NC} (zoxide) for smart directory jumping"
echo -e "  - Use ${YELLOW}UP/DOWN${NC} arrows to search command history"
echo -e "  - Use ${YELLOW}RIGHT${NC} arrow to accept autosuggestions"
echo ""
