...
# @version: 2.0
#
# System configuration, bloatware removal, privacy settings, and WSL setup
# Does NOT install applications - use Setup-Apps.ps1 for application installation
...
# Start logging
$logFile = Join-Path $PSScriptRoot "Setup-System-Log-$(Get-Date -Format 'yyyy-MM-dd-HHmmss').log"
